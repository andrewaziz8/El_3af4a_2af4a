...
public class MyForegroundService extends Service {
    ...
    private static final double MIN_DISTANCE_THRESHOLD = 5.0; // 5 meters
...
//            }
            ...
            double relativeDistance = newDistance - currentObstacleDistance;
            currentObstacleDistance = newDistance;
            if (relativeDistance >= 0 || currentObstacleDistance <= MIN_DISTANCE_THRESHOLD) {
