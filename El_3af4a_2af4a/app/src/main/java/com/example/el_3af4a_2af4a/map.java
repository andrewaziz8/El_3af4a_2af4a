...
public class map extends FragmentActivity implements OnMapReadyCallback {
    ...
    // **Speed Bump Detector:**
    private SpeedBumpDetector speedBumpDetector;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Speed Bump Detector
        speedBumpDetector = new SpeedBumpDetector(this, new SpeedBumpDetector.SpeedBumpListener() {
            @Override
            public void onSpeedBumpDetected() {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(map.this, "Speed Bump Detected!", Toast.LENGTH_SHORT).show();
                        // Add other actions for speed bump detection
                    }
                });
            }
        });
        speedBumpDetector.startDetection();
    ...
    protected void onPause() {
        super.onPause();
        speedBumpDetector.stopDetection();
